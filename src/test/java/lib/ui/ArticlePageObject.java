...
abstract public class ArticlePageObject extends MainPageObject {
    ...
    public void addArticlesToMySaved1() {
        if (Platform.getInstance().isMW()) {
            this.removeArticleFromSavedIfItAdded();
        }
        this.waitForElementAndClick(OPTIONS_ADD_TO_MY_LIST_BUTTON_BEFORE_LOGIN, "Cannot find option to add article to reading list", 5);
    }
